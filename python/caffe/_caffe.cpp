...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(UpdateOverloads, ApplyUpdate, 0, 0);
...
BOOST_PYTHON_MODULE(_caffe) {
  ...
  bp::class_<Net<Dtype>, shared_ptr<Net<Dtype> >, boost::noncopyable >("Net",
    ...
    .def("save", &Net_Save);
    // .def("layer_by_name",const shared_ptr<Layer<Dtype> > layer_by_name(const string& layer_name) const);
  ...
  bp::class_<Layer<Dtype>, shared_ptr<PythonLayer<Dtype> >,
    ...
    .add_property("blobs", bp::make_function(&Layer<Dtype>::blobs,
          bp::return_internal_reference<>()))
    // .add_property("use_data", bp::make_function(&Layer<Dtype>::use_data_,
    //       bp::return_internal_reference<>()))
    .add_property("use_data", bp::make_function(&Layer<Dtype>::UseData,
          bp::return_internal_reference<>()))
  ...
  // bp::class_<SoftmaxWithLossLayer<Dtype>, bp::bases<Layer<Dtype> >,
  //   boost::noncopyable>("SoftmaxWithLossLayer", bp::init<const LayerParameter&>())
  //   .add_property("use_data_array",bp::make_function(&SoftmaxWithLossLayer<Dtype>::UseDataArray,
  //         NdarrayCallPolicies()))
    // .add_property("use_data", bp::make_function(&Layer<Dtype>::UseDataArray,
    //       bp::return_internal_reference<>()))
  ...
  bp::class_<Solver<Dtype>, shared_ptr<Solver<Dtype> >, boost::noncopyable>(
    ...
    .def("step_forward", &Solver<Dtype>::Step_forward)
    .def("step_backward", &Solver<Dtype>::Step_backward)
    .def("step_extra", &Solver<Dtype>::Step_extra)
    .def("apply_update", static_cast<void (Solver<Dtype>::*)(void)>(
      &Solver<Dtype>::ApplyUpdate),UpdateOverloads())
    .def("restore", &Solver<Dtype>::Restore);

  // bp::class_<SoftmaxWithLossLayer<Dtype>, shared_ptr<SoftmaxWithLossLayer<Dtype> >,
  // bp::bases<LossLayer<Dtype> >,boost::noncopyable>(
  //       "SoftmaxWithLoss", bp::init<string>())
  //   .def("use_data", bp::make_function(&SoftmaxWithLossLayer<Dtype>::UseData,
  //       bp::return_value_policy<bp::copy_const_reference>()));

  // bp::class_<SoftmaxWithLossLayer<Dtype>, shared_ptr<SoftmaxWithLossLayer<Dtype> >,
  // bp::bases<LossLayer<Dtype> >,boost::noncopyable>(
  //       "SoftmaxWithLoss", bp::no_init)
  //   .add_property("use_data", &SoftmaxWithLossLayer<Dtype>::use_data_);

  // bp::class_<SoftmaxWithLossLayer<Dtype>, shared_ptr<SoftmaxWithLossLayer<Dtype> >,
  //   bp::bases<Layer<Dtype> >,boost::noncopyable>(
  //     "SoftmaxWithLossLayer", bp::init<const LayerParameter&>())
    // .add_property("use_data", 
    //   bp::make_function(&SoftmaxWithLossLayer<Dtype>::use_data_,
    //       bp::return_internal_reference<>()));
    // .def("UseData", static_cast<Blob<Dtype>& (SoftmaxWithLossLayer<Dtype>::*)()>(
    //     &SoftmaxWithLossLayer<Dtype>::UseData),bp::return_value_policy<bp::copy_const_reference>());
